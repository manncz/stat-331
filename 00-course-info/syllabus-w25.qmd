...
Cal2 <- tibble(date = seq(ymd(20240107), ymd(20240113), by = 1))  |> 
  mutate(mon      = lubridate::month(date, label = T, abbr = F),
         ...
         officehrtime = c(NA, NA, "1:00-2:30pm",NA,  "10:00-\n11:30am", "12:00-1:00pm", NA)
  )
...
conceptual questions, please use the course Discord page (you will join
...
`r fontawesome::fa("computer")` Although you may always work on the
Studio computers, I strongly recommend that you use your own personal
...
::: callout-tip
## **Final Exam** Saturday March 15th time TBD

I am requesting a common final time on 3/15. If you have conflicts with the
common final time, please communicate this to me as soon as possible and
...
-   Check-ins are (typically) due **Mondays at 10:00am**.
...
-   Practice Activities are (typically) due **Wednesdays at 10:00am.**
...
I have taken numerous steps to ensure that all of the materials presented in this course are accessible to all participants, regardless of physical or learning disabilities. HI know that everyone is unique and I may have unintentionally overlooked something that limits access to some materials or activities. Please let me know if you cannot access any content. If you find you need additional accommodations to complete the required course work, please contact me as soon as possible! I want to support your success. 
...
- If you **work with classmates** on an assignment you include a note with their names. 
:::
