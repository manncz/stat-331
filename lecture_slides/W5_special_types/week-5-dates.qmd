...
+ Third section is "takehome" and due **48 hours** after the end of class.
  3. The **Open-Ended Analysis** is completed out of class (should not take more than 3 hours)
...
- Set yourself with a dedicated directory that has the data in it
...
- **PA 5.2: Jewel Heist**
  + due Friday (2/7) at 10:00am
- **Lab 5: Murder in SQL City**
  + due Saturday (2/8) at 11:59pm
- **Read Chapter 6: Version Control**
  + **Check-in 6.1 - 6.2** due Monday (2/10) at 10:00am
