...
Common Final --  Saturday from 1:10pm - 4pm

:::{.columns}
:::{.column}
- Room [42-0205E](https://afd.calpoly.edu/facilities/campus-maps/building-floor-plans/docs/building%20042-0_robert%20a.%20mott%20athletics%20center.pdf)
- **Come to campus early if you drive and park**
- [Road closures](https://content-calpoly-edu.s3.amazonaws.com/deanofstudents/1/images/ADOS/St.%20Patty%27s%20Public%20Map-V8.pdf) may still slow things down in the afternoon
:::
:::{.column}

![](images/cal_poly_map.png)
...
- During Finals:
  - Tuesday and Wednesday by appointment if you would like to discuss your final project report
