...
**Step 3:** Adjust the appropriate variables to be numeric, using `as.numeric()`. Challenge: re-write this code so that it is as efficient as possible using the `across()` function.
...
7.  Out of the two remaining colleges, this college has the least expensive tuition.
